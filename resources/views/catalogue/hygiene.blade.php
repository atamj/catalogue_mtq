...
<html data-wf-page="601d88272311205a78fa1653" data-wf-site="601d786ad06b3f2f840ad293">
@include('partials.head', ['title'=> "catalogue:hygiene"])
<body>
  ...
  <div class="menu">
    ...
    <div class="menu_list">
      ...
      <a href="#ctg__hygiene_bebe" data-w-id="Link Block 21" class="link-block-15 w-inline-block">
  ...
  <div class="section__wrapper">
    <div id="ctg__hygiene_bebe" class="ctg__hygiene_bebe">
      <div class="cat__wrapper">
        ...
        <div class="items-wrapper">
          <div class="w-layout-grid grid">
            <div id="w-node-643069de73f7-78fa1653" class="product eveil_article_01">
    ...
    <div id="ctg__hygiene" class="ctg__hygiene">
      <div class="cat__wrapper">
        <div class="nav-section category-01">
          <a href="#" class="arrow arrow-left w-inline-block"></a>
          <a href="#" class="arrow arrow--right w-inline-block"></a>
          ...
          <div class="spotlight__container">
            ...
            <div class="p__wrapper p__wrapper--spotlight">
              <ul role="list" class="list-3 w-list-unstyled">
                ...
                <li class="p__more_infos more_infos__wrapper more_infos--spotlight">
                  <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f3193" href="#" class="p__more_infos w-inline-block">
                    <div class="more_infos_cross"></div>
                  </a>
                </li>
              </ul>
        ...
        <div class="items-wrapper">
          <div class="w-layout-grid grid">
            <div id="w-node-45453a0f319b-78fa1653" class="product eveil_article_01">
              <div class="product-wrapper">
                <ul role="list" class="list-3 w-list-unstyled">
                  <li class="p__brand">
                    <div class="brand">tex baby</div>
                  ...
                  <li class="p__more_infos more_infos__wrapper">
                    <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f31a2" href="#" class="p__more_infos w-inline-block">
                      <div class="more_infos_cross"></div>
                    </a>
                  </li>
                </ul>
            ...
            <div class="product article__02">
              <ul role="list" class="list-3 w-list-unstyled">
                ...
                <li class="p__more_infos more_infos__wrapper">
                  <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f31c0" href="#" class="p__more_infos w-inline-block">
                    <div class="more_infos_cross"></div>
                  </a>
                </li>
              </ul>
            ...
            <div class="product article__03">
              <ul role="list" class="list-3 w-list-unstyled">
                ...
                <li class="p__more_infos more_infos__wrapper">
                  <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f31df" href="#" class="p__more_infos w-inline-block">
                    <div class="more_infos_cross"></div>
                  </a>
                </li>
              </ul>
            ...
            <div class="product article__03">
              <ul role="list" class="list-3 w-list-unstyled">
                ...
                <li class="p__more_infos more_infos__wrapper">
                  <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f31fe" href="#" class="p__more_infos w-inline-block">
                    <div class="more_infos_cross"></div>
                  </a>
                </li>
              </ul>
            ...
            <div class="product article__03">
              <ul role="list" class="list-3 w-list-unstyled">
                ...
                <li class="p__more_infos more_infos__wrapper">
                  <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f321d" href="#" class="p__more_infos w-inline-block">
                    <div class="more_infos_cross"></div>
                  </a>
                </li>
              </ul>
            ...
            <div class="product article__03">
              <ul role="list" class="list-3 w-list-unstyled">
                ...
                <li class="p__more_infos more_infos__wrapper">
                  <a data-w-id="73d9257e-b088-62e7-e8df-45453a0f323c" href="#" class="p__more_infos w-inline-block">
                    <div class="more_infos_cross"></div>
                  </a>
                </li>
              </ul>
