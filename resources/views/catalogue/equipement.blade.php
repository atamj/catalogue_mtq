...
@include('partials.head', ['title'=> "Catalogue:équipement"])
<body>
{{-- Modal --}}
            ...
            <div class="cat__wrapper">
                ...
                <div class="spotlight spotlight__eveil">
                    <div class="spotlight--img"
                         style="background-image: url('{{asset('images/'.$bombe->where('sous_categorie', $sous_category)->first()->photo_principale)}}')"></div>
                ...
                <div class="items-wrapper">
                    <div class="w-layout-grid grid">
                        @foreach($products->where('sous_categorie', $sous_category)->where('bombe_1', '0') as $product)
                            <div id="w-node-643069de73f7-b30ad297" class="product eveil_article_01" style="background-image: url('{{asset('images/'.$product->photo_principale)}}')">
