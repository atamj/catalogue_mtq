<div class="footer">
    <div class="ftr__top"
         style="background-image: url('{{asset('storage/'.$operation->shortname.'/images/covers/'.$client->id.'/cover.png')}}');
         {{$pivot->footer_top_bgc ? 'background-color:'.$pivot->footer_top_bgc.';' : ""}}{{$pivot->footer_top_color ? 'color:'.$pivot->footer_top_color.';' : ""}}">
    ...
    <div class="ftr__btm" style="{{$pivot->footer_bottom_bgi ? 'background-image: url('.$pivot->footer_bottom_bgi.');' : ""}}
