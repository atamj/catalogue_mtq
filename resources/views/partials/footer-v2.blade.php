<div class="footer">
        ...
        <div class="form w-form">
            <form method="POST"
                ...
                <input type="email" class="text-field w-input"
                       style="{{$pivot->footer_top_color ? 'border-color:'.$pivot->footer_top_color.';color:'.$pivot->footer_top_color.';' : ""}}
    ...
    <div class="ftr__btm"
         style="{{($pivot->footer_bottom_bgi && isset($page) && $page == "catalogue") ? 'background-image: url('.$pivot->footer_bottom_bgi.');' : ""}}
